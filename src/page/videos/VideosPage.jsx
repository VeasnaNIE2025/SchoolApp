...
const curriculum = [
 ...
 lessons: [
  ...
  },
  {
    ...
    open: true,
    lessons: [
      { id: uid(), title: "17.8-ការកំណត់ទំហំជួរឈរ (Distribute Column)", duration: "3:20", done: false, url: "/Videos/Word/17-TableMs0/17.8-DistributeColumn.mp4" },
      { id: uid(), title: "17.9-ការកំណត់ទំហំជួរដេក (Distribute Rows)", duration: "5:45", done: false, url: "/Videos/Word/17-TableMs0/17.9-DistributeRows.mp4" },
      { id: uid(), title: "17.10-ការតម្រឹមអក្សរក្នុងក្រឡា (Text Alignment)", duration: "4:10", done: false, url: "/Videos/Word/17-TableMs0/17.10-TextAlignment.mp4" },
      { id: uid(), title: "17.11-ការកំណត់ទិសដៅក្នុងក្រឡា (Text Direction)", duration: "3:20", done: false, url: "/Videos/Word/17-TableMs0/17.11-TextDirection.mp4" },

      { id: uid(), title: "17.12-ការតម្រៀបទិន្នន័យក្នុងតារាងSort Table", duration: "3:20", done: false, url: "/Videos/Word/17-TableMs1/17.12-SortTable.mp4" },
      { id: uid(), title: "17.13-ការធ្វើឱ្យក្បាលតារាងរត់គ្រប់ជួរ Repeat Header Rows", duration: "5:45", done: false, url: "/Videos/Word/17-TableMs1/17.13-RepeatHeaderRows.mp4" },
      { id: uid(), title: "17.14-ការប្រើប្រាស់រូបមនkនុងតារាងFormular", duration: "4:10", done: false, url: "/Videos/Word/17-TableMs1/17.14-Formular.mp4" },

      { id: uid(), title: "18-ការបញ្ចូលរូបភាព Insert Picture", duration: "3:20", done: false, url: "/Videos/Word/18-Picture/18-InsertPicture.mp4" },
      { id: uid(), title: "18.1-ការប្រើប្រាស់ពន្លឺ djust", duration: "5:45", done: false, url: "/Videos/Word/18-Picture/18.1-djust.mp4" },
      { id: uid(), title: "18.2-ការប្រើប្រាស់ម៉ូតរូបភាពPicture Style", duration: "4:10", done: false, url: "/Videos/Word/18-Picture/18.2-PictureStyle.mp4" },
      { id: uid(), title: "18.3-ការកំណត់ទម្រង់អក្សរជាមួយរូបភាពWrap Text", duration: "4:10", done: false, url: "/Videos/Word/18-Picture/18.3-WrapText.mp4" },

      { id: uid(), title: "18.5-ការរៀបចំលំដាប់ស្រទាប់ (Layer) និងការបង្ហាញ Object", duration: "3:20", done: false, url: "/Videos/Word/18-Picture1/18.5-(Layer-Object).mp4" },
      { id: uid(), title: "18.6-សិក្សាអំពី Select Pane", duration: "5:45", done: false, url: "/Videos/Word/18-Picture1/18.6-SelectPane.mp4" },
      { id: uid(), title: "18.7-សិក្សាអំពី Aligment Object", duration: "4:10", done: false, url: "/Videos/Word/18-Picture1/18.7-AligmentObject.mp4" },
      { id: uid(), title: "18.8-សិក្សាអំពី Group Object", duration: "4:10", done: false, url: "/Videos/Word/18-Picture1/18.8-GroupObject.mp4" },

      { id: uid(), title: "18.9-សិក្សាអំពីការកំណត់ទិសដៅរូបភាព Picture Rotate", duration: "5:45", done: false, url: "/Videos/Word/18-Picture2/18.9-PictureRotate.mp4" },
      { id: uid(), title: "18.10-សិក្សាអំពីការកាត់រូបភាព Picture Crop", duration: "4:10", done: false, url: "/Videos/Word/18-Picture2/18.10-PictureCrop.mp4" },
      { id: uid(), title: "18.11-សិក្សាអំពី ការប្រើអត្ថបទជំនួស Alt Text", duration: "4:10", done: false, url: "/Videos/Word/18-Picture2/18.11-AltText.mp4" },

      { id: uid(), title: "19-សិក្សាអំពី Shape", duration: "4:10", done: false, url: "/Videos/Word/19-Shape/19-Shape.mp4" },
      { id: uid(), title: "19.1-ការ Edit Shape", duration: "4:10", done: false, url: "/Videos/Word/19-Shape/19.1-EditShape.mp4" },
      { id: uid(), title: "19.2-Shape Style", duration: "5:45", done: false, url: "/Videos/Word/19-Shape/19.2-ShapeStyle.mp4" },
      { id: uid(), title: "19.3-Align Text In Shape", duration: "4:10", done: false, url: "/Videos/Word/19-Shape/19.3-AlignTextInShape.mp4" },
      { id: uid(), title: "19.4-ការកំណត់ទិសដៅអក្សរ Text Direction In Shape", duration: "4:10", done: false, url: "/Videos/Word/19-Shape/19.4-TextDirectionInShape.mp4" },
      { id: uid(), title: "19.5-Shape Create Link", duration: "4:10", done: false, url: "/Videos/Word/19-Shape/19.5-ShapeCreateLink.mp4" },

      { id: uid(), title: "20-សិក្សាអំពី Smart Art", duration: "3:20", done: false, url: "/Videos/Word/20-SmartArt/20-SmartArt.mp4" },
      { id: uid(), title: "20.1-សិក្សាអំពីរបៀបបញ្ចូល Smart Art", duration: "5:45", done: false, url: "/Videos/Word/20-SmartArt/20.1-InsertSmartArt.mp4" },
